    ...
    <div class="col-lg-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">Edit Purchase Order</h6>
                <span class="badge bg-warning"><?= ucfirst($purchaseOrder['status']) ?></span>
            </div>
            <div class="card-body">
                ...
                <form action="<?= base_url('/purchase-orders/update/' . $purchaseOrder['id']) ?>" method="post" id="poForm">
                    <?= csrf_field() ?>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-3">
                            ...
                            <small class="form-text text-muted">PO Number cannot be changed</small>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" class="form-control <?= (isset($validation) && $validation->hasError('order_date')) ? 'is-invalid' : '' ?>" 
                                   name="order_date" value="<?= old('order_date', $purchaseOrder['order_date']) ?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="notes" rows="3" placeholder="Additional notes..."><?= old('notes', $purchaseOrder['notes']) ?></textarea>
                    </div>

                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="<?= base_url('/purchase-orders/view/' . $purchaseOrder['id']) ?>" class="btn btn-secondary me-2">Cancel</a>
...
<script>
    ...
    const existingItems = <?= json_encode($poItems) ?>;
    ...
    function addItemRow(itemData = null) {
        ...
        const itemSelect = createItemSelect(itemData?.item_id);
    ...
    function createItemSelect(selectedId = null) {
        ...
        return `<select class="form-control item-select" name="items[${itemCounter}][item_id]" required>
                    ${options}
                </select>`;
    }
